...
- Choose your own renderer ([Lighterhtml](fixtures/lighterhtml), [Lit-html](fixtures/lit-html), [Htm-preact](fixtures/htm-preact), [Superfine](fixtures/superfine), everything that outputs DOM...)
